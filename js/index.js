...
let flipCardReduce = document.getElementById('flip-card-reduce');
console.log(flipCardReduce);

  if (document.getElementById('flip-card-reduce').style.display == 'block') {
    document.getElementById('flip-card-reduce').innerHTML = 'Teotihuacan is' celcius + '&deg;' + 'C now.';
  }
  //  else {
